...
export const act3CaseE = {
  ...
  evidencePool: [
    ...
    {
      id: "manner_of_death_testimony",
      name: "Testimony About the Manner of His Death",
      type: "testimonial",
      icon: "../assets/gfx/scroll-duotone.svg",
      location: "Women’s Viewpoint, Golgotha",
      desc: "Corroborating testimony from Mary mother of James and Joses and from Salome: Jesus gave a loud cry and breathed His last in a manner that moved the centurion facing Him to confess that He was the Son of God.",
      bibleRef: "Mark 15:39–41 — the centurion saw how Jesus died, while Mary Magdalene, Mary mother of James the younger and Joses, Salome, and many other women watched nearby.",
      bibleLink: "mark_15_39_41",
      propheticLink: "The women’s testimony independently corroborates the centurion’s response and connects Jesus’s deliberate final cry with the public manner of His death.",
      bibleRefs: [
        { ref: "Mark 15:39–41", link: "mark_15_39_41" }
      ],
      propheticRefs: [],
      investigatorNote: "The centurion and the women observed from different positions and with different loyalties, yet their accounts converge on the same unusual death.",
      fake: false,
      category: "event",
      timelineOrder: 3,
      clues: {
        compare: "Pairs with the Transcript of the Aramaic Cry: the named women heard the cry and then witnessed His final breath.",
        link: "Witness chain — Mary and Salome corroborate the centurion’s account in Mark 15:39–41.",
        timeline: "CHRONOLOGY: Jesus’s loud cry and death occurred at the ninth hour, before the burial.",
        contradict: "RELIABILITY: Named followers and a Roman execution officer independently describe the same final moment."
      }
    },
  ...
  npcs: [
    {
      ...
      hasDialogue: true,
      storyFile: "centurion_background",
    ...
    },
    {
      ...
      hasDialogue: true,
      storyFile: "joseph_arimathea_cross",
    ...
    },
    {
      ...
      role: "Follower from Galilee, Crucifixion Witness",
      faction: "local",
      avatar: "mary_bethany.svg",
      truthfulness: 0.98,
      bibleRef: "Mark 15:33–41, 47; Matthew 27:55–56",
      hasDialogue: true,
      storyFile: "mary_james_joses",
      unlocksEvidence: ["the_forsaken_cry", "manner_of_death_testimony", "distant_witnesses"],
      revealsProphecy: "psalm_22_1",
      background: "A long-standing follower who came up from Galilee and watched Jesus's crucifixion from a distance alongside Salome, Mary Magdalene, and many other women. She also observed where Jesus was buried.",
      dialogue: {
        neutral: "We stood at a distance, but we heard His cry and saw the manner of His death.",
        repeat: "Salome and the other women saw it too. Our testimony does not stand alone.",
      },
      reactions: {
        the_forsaken_cry: { text: "I heard the Aramaic words clearly. Some mistook 'Eloi' for Elijah, but He was quoting Psalm 22.", isLie: false },
        manner_of_death_testimony: { text: "He gave a loud cry and breathed His last. The centurion facing Him saw the same thing and confessed that He was the Son of God.", isLie: false },
        distant_witnesses: { text: "Mary Magdalene, Salome, and many other women who came up with Him to Jerusalem were there with me.", isLie: false },
      },
      contradictions: {},
    },
    {
      id: "salome_crucifixion",
      name: "Salome",
      role: "Follower from Galilee, Crucifixion Witness",
      faction: "local",
      avatar: "mary_magdalene.svg",
      truthfulness: 0.98,
      bibleRef: "Mark 15:33–41; Mark 16:1",
      hasDialogue: true,
      storyFile: "salome_crucifixion",
      unlocksEvidence: ["the_forsaken_cry", "manner_of_death_testimony", "distant_witnesses"],
      revealsProphecy: "psalm_22_1",
      background: "A follower who supported Jesus's ministry in Galilee, witnessed His crucifixion with the other women, and later returned to the tomb with spices.",
      dialogue: {
        neutral: "We were there. We heard what He cried and watched how He died.",
        repeat: "Mary and the many women from Galilee can corroborate what I saw.",
      },
      reactions: {
        the_forsaken_cry: { text: "'Eloi, Eloi, lema sabachthani?' The words carried through the darkness. He was quoting Psalm 22.", isLie: false },
        manner_of_death_testimony: { text: "The centurion stood facing Him and watched how He died. We witnessed that same final moment from farther back.", isLie: false },
        distant_witnesses: { text: "Mark names three of us, then records that many other women who came up with Him to Jerusalem were also there.", isLie: false },
      },
      contradictions: {},
    },
    ,
