...
export const act2CaseB = {
  ...
  npcs: [
    ...
    },
    {
      ...
      pos: [5, 0, 12],
      hasDialogue: true,
      storyFile: "parable_meaning_lazarus",
    ...
    },
    {
      ...
      profileFile: "caiaphas",
      truthfulness: 0.35,
      bibleRef: "John 11:47-53; John 18:14",
      pos: [0, 0, 10],
      hasDialogue: true,
      storyFile: "caiaphas_lazarus",
      unlocksSuspects: ["caiaphas"],
      unlocksEvidence: ["grave_dirt"],
      background: "High Priest Joseph ben Caiaphas, theologically Sadducean but politically pragmatic. Faced with Lazarus's resurrection miracle, he concluded one man must die to protect the nation, unknowingly prophesying Christ's atonement.",
      dialogue: {
        neutral: "The crowd's madness spreads like disease. We convened an emergency council — Lazarus's existence threatens everything.",
      },
    },
    {
      id: "the_king",
      name: "Lazarus",
      role: "Raised from the Dead",
      avatar: "lazarus.svg",
      profileFile: "lazarus",
      truthfulness: 0.95,
      bibleRef: "John 11:1-44; John 12:9-11",
      pos: [10, 0, 0],
      hasDialogue: true,
      storyFile: "the_king",
      unlocksEvidence: ["crowd_report"],
      background: "Raised from the dead by Jesus after four days in the tomb. Now a living sign of Jesus's power over death — and a target of the Sanhedrin who see him as evidence that must be eliminated.",
      dialogue: {
        neutral: "They call me the King of the Jews now. I remember the silence of the tomb, and the voice that called me out.",
      },
    },
  ],
...
export const act2CaseC = {
  ...
  npcs: [
    ...
    },
    {
      ...
      bibleRef: "Matthew 24:3",
      hasDialogue: true,
      storyFile: "parable_meaning_olivet",
