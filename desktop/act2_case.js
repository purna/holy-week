...
// CASE EXPORT: authority_challenged
// SOURCE: act2_case_3d.js
// BACKGROUND: Coordinated challenges from the Sanhedrin attempting to discredit Jesus in the Temple courts.
...
//   Culprit: caiaphas
//   Motive: Political preservation and fear of institutional displacement.
// ============================================================
...
// CASE FACTS (Truth Object):
//   Culprit: caiaphas
//   Motive: Security preservation and institutional control.
// ============================================================
...
export const act2CaseC = {
  ...
  npcs: [
    ...
    },
    {
      id: "andrew_disciple",
      name: "Andrew",
      role: "Disciple, Witness to Prophecy",
      faction: "scribes",
      avatar: "⛪",
      profileFile: "andrew_disciple",
      color: 0x66aaff,
      pos: [-3, 0, 5], // Example position, adjust as needed
      truthfulness: 0.95,
      bibleRef: "Matthew 24:3",
      hasDialogue: true,
      storyFile: "andrew_olivet",
      unlocksSuspects: ["andrew_disciple"],
      unlocksEvidence: ["disciples_questions_notes", "cosmic_signs_references"],
      background: "One of the inner circle who accompanied Jesus to the Mount of Olives. He is deeply troubled by the prophecies regarding the Temple's destruction.",
      dialogue: {
        neutral: "He spoke of the end, Scribe. Not just of our lives, but of those great stones down there. He says not one will be left standing.",
        cautious: "He warned us of deceptions and wars. But he also said the Good News must reach all nations first. It's a heavy burden to carry.",
        pressured: "That is what we thought. But look at his face—he isn't guessing. He is mourning what he knows is coming.",
        exposed: "Watch and pray. Those were his words. The Temple will fall, but the Son of Man will return.",
        repeat: "I've told you what I heard. It's a lot to take in."
      },
      reactions: {},
      contradictions: {},
    },
