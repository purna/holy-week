  ...
  evidencePool: [
    {
      ...
      snippet: "Two folded Galilean travelling cloaks.",
    ...
    },
    {
      ...
      snippet: "Small, light hoofprints heading toward Jerusalem.",
      description: "Clear hoofprints of a small donkey — a colt's prints, lighter than an adult's — lead down the western slope of the Mount of Olives toward Jerusalem.",
    ...
    },
    {
      ...
      snippet: "Eyewitness account of the donkey's release.",
      description: "A local villager reports seeing two men untying the colt at dawn. When challenged — 'Why are you untying it?' — they answered: 'The Lord needs it.' The owner then nodded and let them go.",
      revealsSuspect: "none",
    ...
    },
    {
      ...
      snippet: "A well-read scroll fragment of Zechariah 9:9.",
    ...
    },
    {
      ...
      snippet: "A fresh, green palm branch, carried from a distance.",
    ...
    },
    {
      ...
      snippet: "A cleanly cut rope with a simple knot.",
      description: "The rope used to tie the colt has been cut cleanly — not frayed or broken, suggesting deliberate untying or cutting with a tool. The knot style is a simple shepherd's hitch.",
    ...
    },
    {
      ...
      snippet: "A written complaint regarding public disorder.",
...
export const act1CaseC = {
  ...
  evidencePool: [
    ...
    },
    {
      ...
      bibleRef: "Mark 11:21",
      propheticLink: "Peter's reaction highlights the disciples' growing understanding of Jesus's divine authority, not just over nature, but as a prophetic judge.",
    ...
    },
    {
      ...
      propheticLink: "This teaching connects the prophetic act of judgment (the withered tree) with the power available to believers through faith and prayer, emphasizing the spiritual principles behind the physical event.",
  ...
  npcs: [
    {
      ...
      bibleRef: "Mark 11:20–21",
      hasDialogue: true,
      storyFile: null, // Using inline dialogue for this specific instance
