...
| Priestly Robe Fragment (`torn_robe`) | `isaiah_50_6` | Matthew 26:65 | Caiaphas tore his robes to signal blasphemy when Jesus affirmed His divinity. Moments later the guards struck and spat on Jesus (Matthew 26:67–68) — the mocking and beating Isaiah 50:6 foretold ('I gave my back to those who beat me, my cheeks to those who pulled out my beard; I did not hide my face from mocking and spitting'). |
...
| The Miraculous Catch (`miraculous_catch`) | `ezekiel_34_11-16` | John 21:10-11 — 'Bring some of the fish you have just caught... There were so many that the fisherman was not able to haul in the net, for it was torn.' | This echoes the original calling of the disciples (Luke 5:1-11) and demonstrates that obedience to Christ yields supernatural results. |
| Bread and Fish Breakfast (`bread_breakfast`) | `ezekiel_34_11-16` | **[CORRECTED]** John 21:9 — 'Jesus said, "Come and have breakfast."' | The 'bread of life' (John 6) now eats bread with Peter — the broken bread that once condemned him now nourishes him. |
