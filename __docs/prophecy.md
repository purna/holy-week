...
- [act2CaseD — The Passover Lamb](#act2cased--the-passover-lamb-new-investigation-chain)
...
Each case also has a **Fulfillment & Typology Links** table listing every Bible reference an evidence cites, so each link is readable on its own line.
...
## act2CaseD — The Passover Lamb (New Investigation Chain)
...
| Evidence | `relatedProphecy` (Codex) | `bibleRef` (supporting verse) | Prophetic / Narrative Link Text |
|---|---|---|---|
| Flask of Pure Nard (`nard_flask`) | `typology_passover_lamb` | John 12:1–3 | Anointing of Jesus's feet six days before Passover — parallel to setting apart and preparing the lamb's feet/legs (Exodus 12:3–6). |
| Broken Alabaster Jar (`alabaster_jar`) | `typology_passover_lamb` | Matthew 26:6–7 | Anointing of Jesus's head two days before Passover — parallel to the public declaration that the lamb is without blemish. |
...
| Bethany Limestone Dust (`grave_dirt`) | `isaiah_25_8` | John 11:39 records Martha's objection that after four days there would already be a bad odor — the natural expectation of decay this deep into a Judean burial, against which the raising of Lazarus stands out as a reversal. | - |
...
| Genesis 14:18-20 | `typology_melchizedek` |
| Exodus 24:8 | `exodus_24_8` |
...
| List of the Twelve (`twelve_roll`) | `isaiah_53_12` | Luke 22:37 — 'For I tell you that this which is written must be fulfilled in me: "And he was numbered with the transgressors."' | Jesus explicitly applies Isaiah 53:12 to Himself during the Last Supper, explaining that His association with the twelve, including a traitor, fulfills the prophecy of being counted among criminals. |
| Spilled Wine on the Linen (`wine_stain`) | `typology_melchizedek` | Genesis 14:18 — 'And Melchizedek king of Salem brought out bread and wine. (He was priest of God Most High.)' | Melchizedek, the mysterious priest-king of Salem (Jerusalem), blessed Abraham with bread and wine. This act is seen as a "type" or foreshadowing of Christ. The book of Hebrews explains that Jesus is a high priest "forever in the order of Melchizedek" (quoting Psalm 110), an eternal priesthood outside the Levitical line. Just as Melchizedek offered bread and wine, Jesus institutes the New Covenant with the same elements at the Last Supper. |
| Covenant Seal Mark (`covenant_seal`) | `exodus_24_8` | Exodus 24:8; Luke 22:20 | Exodus 24:8 records Moses sealing the old covenant with blood. Jesus's words over the cup — 'This is my blood of the covenant' — directly echo this, establishing the New Covenant in His own blood. |
...
| Spilled Wine on the Linen (`wine_stain`) | Genesis 14:18-20 | genesis_14_18 |
| Spilled Wine on the Linen (`wine_stain`) | Hebrews 7 | hebrews_7 |
| Covenant Seal Mark (`covenant_seal`) | Exodus 24:8 | exodus_24_8 |
| Covenant Seal Mark (`covenant_seal`) | Luke 22:20 | luke_22_20 |
...
| Unresisting Prisoner's Cord (`prisoner_cord`) | Matthew 26:52–54 | matthew_26_52 |
...
| Guard's Reed (`guard_reed`) | Matthew 26:67–68 | matthew_26_67 |
...
| Perjured Witness Statement (`perjured_testimony`) | Mark 14:57–59 | mark_14_57 |
| Silent Witness Account (`silent_account`) | Isaiah 53:7 | isaiah_53_7 |
| Silent Witness Account (`silent_account`) | Matthew 26:57–68 | matthew_26_57 |
...
| Psalm 22:16 | `psalm_22_16` |
| Psalm 22:18 | `psalm_22_18` |
...
| Exodus 12:46 | `exodus_12_46` |
| Numbers 19 (Red Heifer) | `typology_red_heifer` |
| Genesis 22 (Isaac Carrying the Wood) | `typology_isaac_wood` |

### Evidence Links

| Evidence | `relatedProphecy` (Codex) | `bibleRef` (supporting verse) | Prophetic / Narrative Link Text |
|---|---|---|---|
| Cry of Abandonment (`last_cry_abandonment`) | `psalm_22_1` | Matthew 27:46; Mark 15:34 — 'About three in the afternoon Jesus cried out in a loud voice, "My God, my God, why have you forsaken me?"' | Psalm 22:1 — "My God, my God, why have you forsaken me?" The opening verse of the crucifixion psalm, quoted by Jesus in His darkest hour, initiates the entire chain of fulfillment. |
...
| Soldiers' Casting Dice (`split_dice`) | `psalm_22_18` | John 19:23–24 — 'Let's not tear it,' they said to one another. 'Let's decide by lot who will get it.' This happened that the scripture might be fulfilled... | Directly fulfils Psalm 22:18. While the victim hung dying, the execution detail cast lots for a high-quality, seamless tunic woven from top to bottom. |
| Blood-Stained Roman Hasta (`pierced_spear`) | `zechariah_12_10` | John 19:34 — 'Instead, one of the soldiers pierced Jesus's side with a spear, bringing a sudden flow of blood and water.' | Fulfils Zechariah 12:10 ('the one they have pierced'). The spear thrust proved the victim was already dead, making the leg-breaking unnecessary. |
| Shattered Limestone Fragment (`shattered_limestone`) | `typology_red_heifer` | Hebrews 13:12–13; Numbers 19 | The Red Heifer was sacrificed and its blood carried outside the camp. Jesus, the perfect sacrifice, suffered outside the city gates — the earthquake and rocksplit testify to the cosmic significance. |
...
| Unbroken Tibiae Report (`unbroken_legs`) | `exodus_12_46` | John 19:31–36 | The Passover lamb's bones were not to be broken (Exodus 12:46). Christ, the true Passover Lamb, fulfills this — no bones were broken in His execution. |
| Final Words Scroll (`final_words`) | `psalm_31_5` | Luke 23:46 — 'Jesus called out with a loud voice, "Father, into your hands I commit my spirit."' | Jesus's final words from the cross are a direct quote from Psalm 31:5, a prayer of ultimate trust in God at the moment of death. |
| Sponge Soaked in Sour Wine (`sour_wine_sponge`) | `psalm_69_21` | John 19:28–29 — 'Jesus, knowing that all was now finished, said (to fulfill the Scripture), "I thirst." ... they put a sponge full of the sour wine on a hyssop branch and held it to his mouth.' | This act directly fulfills Psalm 69:21 ("...for my thirst they gave me sour wine to drink"). The deliberate mention of a hyssop branch also powerfully evokes the Passover (Exodus 12:22), where hyssop was used to apply the lamb's blood for salvation, identifying Jesus as the true Passover Lamb. |
| Simon of Cyrene's Burden (`simon_cyrene_burden`) | `typology_isaac_wood` | Genesis 22:6; Luke 23:26 | Isaac carried the wood for the offering; Jesus carries the cross. Both willingly bore the means of their own sacrifice, prefigured in Genesis 22's binding of Isaac. |
...
| Evidence | Reference | Bible ID |
|---|---|---|
| Cry of Abandonment (`last_cry_abandonment`) | Psalm 22:1 | psalm_22_1 |
| Cry of Abandonment (`last_cry_abandonment`) | Matthew 27:46 | matthew_27_46 |
| Mocking Crown of Thorns (`mockery_crown`) | Psalm 22:7–8 | psalm_22_7_8 |
| Mocking Crown of Thorns (`mockery_crown`) | Matthew 27:29–31 | matthew_27_29 |
| Crucifixion Nails (`crucifixion_nails`) | Psalm 22:16 | psalm_22_16 |
| Crucifixion Nails (`crucifixion_nails`) | Luke 24:39–40 | luke_24_39 |
...
| Shattered Limestone Fragment (`shattered_limestone`) | Numbers 19 | numbers_19 |
...
| Unbroken Tibiae Report (`unbroken_legs`) | Exodus 12:46 | exodus_12_46 |
| Unbroken Tibiae Report (`unbroken_legs`) | John 19:31–36 | john_19_31 |
...
| Sponge Soaked in Sour Wine (`sour_wine_sponge`) | John 19:28–29 | john_19_28 |
| Simon of Cyrene's Burden (`simon_cyrene_burden`) | Genesis 22:6 | genesis_22 |
| Simon of Cyrene's Burden (`simon_cyrene_burden`) | Luke 23:26 | luke_23_26 |
| Hyssop Branch (`hyssop_branch`) | John 19:29 | john_19_29 |
| Hyssop Branch (`hyssop_branch`) | Exodus 12:22 | exodus_12_22 |
...
| Leviticus 23:9–14 | `leviticus_23_firstfruits` |
...
| The Soldiers' Broken Report (`guard_report`) | `hosea_6_2` | Matthew 28:2–4 — 'The guards shook for fear of him and became like dead men.' Matthew 28:11–15 — the chief priests bribed the guards to say the disciples had stolen the body. | The bribe to the guards fulfils the pattern of institutional deception against God's purposes — similar to how the chief priests had bribed Judas (Matthew 26:14–16). The very people who guarded against resurrection were the first non-disciple witnesses of the supernatural event. |
...
| Sign of Jonah (`sign_of_jonah`) | `jonah_1_17___matthew_12_40` | Matthew 12:40 — 'For as Jonah was three days and three nights in the belly of a huge fish, so the Son of Man will be three days and three nights in the heart of the earth.' | Jesus named His own third-day resurrection the 'sign of Jonah,' the three days in the tomb mirroring Jonah's three days in the great fish. |
...
| Resurrection Psalm Scroll (`psalm22_scroll`) | Luke 24:26–27 | luke_24_26 |
| Sign of Jonah (`sign_of_jonah`) | Jonah 1:17 / Matthew 12:40 | jonah_1_17___matthew_12_40 |
| Sign of Jonah (`sign_of_jonah`) | Matthew 12:40 | matthew_12_40 |
| Firstfruits Offering (`firstfruits_offering`) | Leviticus 23:9–14 | leviticus_23_9_14 |
...
| Official Sanhedrin Report (`sanhedrin_report`) | `psalm_2_1_2` | Matthew 28:11 — 'While the women were on their way, some of the guards went into the city and reported to the chief priests everything that had happened.' | This report is the paper trail of the conspiracy itself — the Sanhedrin's own internal record of receiving the guards' account and choosing to suppress rather than investigate it, matching the pattern of rulers plotting against God's anointed described in Psalm 2:1–2. |
...
| Evidence | `relatedProphecy` (Codex) | `bibleRef` (supporting verse) | Prophetic / Narrative Link Text |
|---|---|---|---|
| The Charcoal Fire (`charcoal_fire`) | `zechariah_13_7` | John 21:9 — 'When they got out of the boat, they saw a fire of burning coals there with fish lying on it, and bread.' | The fire triggers Peter's memory of his denial, but now transforms that shame into restoration around the risen Christ. The scattered sheep (Zechariah 13:7) is now being gathered by the Shepherd. |
| The Miraculous Catch (`miraculous_catch`) | `ezekiel_34_11-16` | John 21:10–11 — 'Bring some of the fish you have just caught... Although there were so many, the net was not torn.' | This echoes the original calling of the disciples (Luke 5:1-11) and demonstrates that obedience to Christ yields supernatural results. It's a living parable of Ezekiel 34, where God promises to search for His sheep and bring them out from the nations. |
| Bread and Fish Breakfast (`bread_breakfast`) | - | John 21:9 — 'When they landed, they saw a fire of burning coals there with fish on it, and some bread.' | The 'bread of life' (John 6) now eats bread with Peter — the broken bread that once condemned him now nourishes him. |
| The Threefold Commission (`threefold_commission`) | `ezekiel_34_11-16` | John 21:15-17 — 'Feed my lambs... Feed my sheep... Tend my sheep.' | Peter's three denials are met with three commissions to shepherd God's flock, directly fulfilling the role of the good shepherd described in Ezekiel 34. |
| Risen Appearance (`galilean_apparition`) | - | John 21:12 — 'Jesus said to them, "Come and have breakfast." None of the disciples dared ask him, "Who are you?" They knew it was the Lord.' | Despite seeing Him die, the disciples knew — supernaturally — who stood before them. Faith recognized its Author. |
...
| The Miraculous Catch (`miraculous_catch`) | Ezekiel 34:11-16 | ezekiel_34_11_16 |
...
|---|---|---|---|
| `sanhedrin_trial` (act3CaseC) | High Priest's Role | `Silent Witness Account` (`silent_account`) | `isaiah_53_7` |
| `barabbas_choice` (act3CaseD) | Scapegoat (Azazel) | `The Insurgent's Dossier` (`barabbas_warrant`) | `isaiah_53_3` |
| `crucifixion_site` (act3CaseE) | Blood of Atonement | `Crucifixion Nails` (`crucifixion_nails`), `Mocking Crown of Thorns` (`mockery_crown`) | `psalm_22_1`, `psalm_22_7_8` |
...
**Complete Chain Evidence:** `silent_account` + `barabbas_warrant` + `crucifixion_nails` + `mockery_crown`
...
| Case | Typological Element | Evidence | Bible ID |
|---|---|---|---|
| `last_supper` (act3CaseA) | The Wood | `Spilled Wine on the Linen` (`wine_stain`) | `typology_melchizedek` |
| `gethsemane_arrest` (act3CaseB) | The Binding | `Unresisting Prisoner's Cord` (`prisoner_cord`) | `isaiah_53_7` |
| `crucifixion_site` (act3CaseE) | The Sacrifice | `Simon of Cyrene's Burden` (`simon_cyrene_burden`) | `typology_isaac_wood` |

**Fulfillment:** Isaac carried the wood for his sacrifice; Jesus carries the cross. Both were bound, both carried their own means of death, both went willingly. Abraham's question "Where is the lamb?" (Genesis 22:7) is answered 2,000 years later: "Behold the Lamb of God" (John 1:29). The ram caught in the thicket prefigures God providing the sacrifice — Christ, the spotless Lamb, substituted for sinners.

**Complete Chain Evidence:** `wine_stain` + `prisoner_cord` + `simon_cyrene_burden`
...
| `sanhedrin_trial` (act3CaseC) | Peter denies | `Silent Witness Account` (`silent_account`) | Contrast (Jesus silent, Peter speaks) |
...
**Complete Chain Evidence:** `abandoned_linen` + `silent_account` + `charcoal_fire`
