...
- **Additional Dialogue File:** [temple_curtain.ink](temple_curtain.ink)
- **Acts / Cases:** Act III (`crucifixion_site`)

**Identity:** *Not documented.*

**Social Status:** *Not documented.*

**Apparent Age:** *Not documented.*

**Immediate Stress Level:** *Not documented.*
...
- **Source Dialogue(s):** `pharisee_critique.json`
...
- **Source Dialogue(s):** `priest_objection.json`
...
- **Additional Dialogue File:** [peter_donkey.ink](peter_donkey.ink)
- **Source Dialogue(s):** `peter_defense.json`, `peter_denial.json`
...
- **Additional Dialogue File:** [corrupt_seller.ink](corrupt_seller.ink)
...
### 13. The Galilean Pilgrim

- **Additional Dialogue File:** [galilean_pilgrim.ink](galilean_pilgrim.ink)
...
- **Additional Dialogue File:** [jerusalem_local.ink](jerusalem_local.ink)
...
- **Additional Dialogue File:** [money_changer.ink](money_changer.ink)
- **Acts / Cases:** Act I (`temple_cleansing`)
...
### 16. Annas the Patriarch

- **Additional Dialogue File:** [annas_patriarch.ink](annas_patriarch.ink)
...
- **Additional Dialogue File:** [caiaphas_priest.ink](caiaphas_priest.ink)
...
- **Additional Dialogue File:** [eleazar_sadducee.ink](eleazar_sadducee.ink)
- **Acts / Cases:** Act I (`triumphal_entry`)
...
- **Additional Dialogue File:** [joseph_arimathea.ink](joseph_arimathea.ink)
...
- **Additional Dialogue File:** [temple_spy.ink](temple_spy.ink)
- **Acts / Cases:** Act II (`lazarus_plot`)
...
### 23. John the Beloved Disciple

- **Additional Dialogue File:** [john_disciple.ink](john_disciple.ink)
- **Additional Dialogue File:** [john_donkey.ink](john_donkey.ink)
...
- **Additional Dialogue File:** [martha_bethany.ink](martha_bethany.ink)
...
- **Additional Dialogue File:** [pilates_secretary.ink](pilates_secretary.ink)
...
- **Additional Dialogue File:** [pontius_pilate.ink](pontius_pilate.ink)
...
- **Additional Dialogue File:** [teaching_mount.ink](teaching_mount.ink)
...
- **Additional Dialogue File:** [barabbas_insurgent.ink](barabbas_insurgent.ink)
- **Acts / Cases:** Act III (`barabbas_choice`)
...
- **Additional Dialogue File:** [secret_visit.ink](secret_visit.ink)
...
- **Additional Dialogue File:** [rhoda_servant.ink](rhoda_servant.ink)
- **Acts / Cases:** Act III (`last_supper`)
...
- **Additional Dialogue File:** [simon_cyrene.ink](simon_cyrene.ink)
- **Acts / Cases:** Act III (`crucifixion_site`)
...
- **Additional Dialogue File:** [execution_soldier.ink](execution_soldier.ink)
- **Acts / Cases:** Act III (`crucifixion_site`)
...
## Appendix A: Essential Jerusalem Events During Holy Week
...
This document was restructured from a working draft that had accumulated significant duplication (the same character groups were pasted in full three times, in decreasing levels of detail, plus a fourth reorganization by investigation phase). The consolidation applied the following rules:

- **One entry per character.** Where the same character appeared multiple times, the most complete version (fullest Identity/Social Status/Stress/Linguistic Style/Dialogue Tree Function and Dialogue Coverage Table) was kept as canonical.
- **Scene variants merged, not discarded.** A handful of characters had genuinely different dialogue files attached to different duplicate listings (e.g. Judas Iscariot's "Betrayal Echo" scene, Mary Magdalene's "Garden Witness" scene, Pashhur's two separate appearances). These were folded into that character's single entry as additional dialogue coverage rather than dropped.
