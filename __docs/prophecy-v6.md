...
| Discarded Whip of Cords (`whip_of_cords`) | `psalm_69_9` | John 2:15 | John 2:15 specifically details Him weaving this instrument on the spot before initiating the cleansing. The disciples later recalled that this act fulfilled Psalm 69:9: "Zeal for your house will consume me." |
...
| Discarded Whip of Cords (`whip_of_cords`) | Psalm 69:9 | psalm_69_9 |
...
| Shattered Limestone Fragment (`shattered_limestone`) | - | Matthew 27:51 — 'The earth shook, the rocks split and the tombs broke open.' | The earthquake, combined with the three hours of darkness described elsewhere in this case's evidence, served as a cosmic response to the execution. |
...
| Unbroken Tibiae Report (`unbroken_legs`) | `psalm_34_20` | John 19:31–36 | Jesus' legs were not broken, fulfilling the Passover Lamb imagery (Exodus 12:46) and Psalm 34:20: "He protects all his bones, not one of them will be broken." |
