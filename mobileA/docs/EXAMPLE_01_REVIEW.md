...
- `act1-4_case_2d.js` — Case data definitions
...
### How It Works
- NPCs defined in `actX_case_2d.js` with full data objects
- Each NPC has:
...
### Case Structure
Each case (`actX_case_2d.js`) exports objects with:
