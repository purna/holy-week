...
export class NPCSystem {
  constructor(caseManager, evidenceSystem, config = {}) {
  ...
  async loadCase(caseData) {
    ...
    const debugUnlockAll = this.config?.DEBUG?.unlockAllPeople;
    ...
    for (const npc of allNPCs) {
      ...
      this.npcStates[npc.id] = {
        ...
        isSuspectUnlocked: debugUnlockAll || npc.isSuspectUnlocked || discovered.includes(npc.id) || npc.id === "none"
      };
    }
