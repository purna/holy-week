...
CASE_FILES = [
    ("act1_case.js", [
        ...
        "act1CaseC",  # fig_tree_incident / The Barren Fig Tree
    ]),
    ("act2_case.js", [
        "act2CaseA",  # authority_challenged / The Silenced Teacher
        "act2CaseB",  # lazarus_plot / The Price of Life
        "act2CaseC",  # olivet_discourse / The End of the Age
        "act2CaseD",  # passover_lamb_chain / The Anointing at Bethany
    ]),
    ("act3_case.js", [
        "act3CaseA",  # last_supper / The Broken Cup
        "act3CaseB",  # gethsemane_arrest / The Severed Ear
        "act3CaseC",  # sanhedrin_trial / The Midnight Tribunal
        "act3CaseD",  # barabbas_choice / The People's Choice
        "act3CaseE",  # crucifixion_site / The Final Sacrifice
    ]),
    ("act4_case.js", [
        ...
        "act4CaseD",  # ascension / The Ascension
    ]),
]
...
CASE_EXPORT_TO_ID = {
    ...
    'act1CaseC': 'fig_tree_incident', # Added
    'act2CaseC': 'olivet_discourse', # Added
    'act2CaseD': 'passover_lamb_chain', # Added
    'act3CaseA': 'last_supper',
    'act3CaseB': 'gethsemane_arrest',
    'act3CaseC': 'sanhedrin_trial',
    'act3CaseD': 'barabbas_choice',
    'act3CaseE': 'crucifixion_site', # Added
...
ACT_MAP = {
    ...
    'lazarus_plot': 'Act II',
    'olivet_discourse': 'Act II',
    'passover_lamb_chain': 'Act II',
    'fig_tree_incident': 'Act II',
    'last_supper': 'Act III',
    'gethsemane_arrest': 'Act III',
    'sanhedrin_trial': 'Act III',
    'barabbas_choice': 'Act III',
    'crucifixion_site': 'Act III',
    'resurrection': 'Act IV',
    'roman_inquiry': 'Act IV',
    'peter_restoration': 'Act IV',
    'ascension': 'Act IV',
}

# Verified mapping from backward search of storyFile references
STORY_NPC_MAP = {
    'galilean_pilgrim': {'case_export': 'act1CaseA', 'npc_id': 'owner', 'npc_name': 'Tobias'}, # Correct
    'jerusalem_local': {'case_export': 'act1CaseA', 'npc_id': 'local_skeptic', 'npc_name': 'Jemimah'}, # Correct
    'peter_donkey': {'case_export': 'act1CaseA', 'npc_id': 'peter', 'npc_name': 'Peter'}, # Correct
    'john_donkey': {'case_export': 'act1CaseA', 'npc_id': 'john', 'npc_name': 'John'}, # Correct
    'money_changer': {'case_export': 'act1CaseB', 'npc_id': 'money_changer', 'npc_name': 'Malachi (Money Changer)'}, # Corrected npc_id
    'guard_report': {'case_export': 'act1CaseB', 'npc_id': 'garrison_guard', 'npc_name': 'Marcus (Garrison Guard)'}, # Correct
    'nathan_fig_tree': {'case_export': 'act1CaseC', 'npc_id': 'nathan_gardener', 'npc_name': 'Nathan'}, # Added
    'peter_fig_tree': {'case_export': 'act1CaseC', 'npc_id': 'peter_fig_tree', 'npc_name': 'Peter'}, # Added
    'john_fig_tree': {'case_export': 'act1CaseC', 'npc_id': 'john_fig_tree', 'npc_name': 'John'}, # Added
    'local_traveler': {'case_export': 'act1CaseC', 'npc_id': 'local_traveler_fig_tree', 'npc_name': 'Local Traveler'}, # Added
    ...
    'roman_assessment': {'case_export': 'act3CaseE', 'npc_id': 'centurion_longinus', 'npc_name': 'Centurion Longinus'},
    'caiaphas_priest': {'case_export': 'act3CaseC', 'npc_id': 'caiaphas_trial', 'npc_name': 'Caiaphas'},
    'joseph_arimathea': {'case_export': 'act3CaseE', 'npc_id': 'joseph_arimathea', 'npc_name': 'Joseph of Arimathea'},
    ...
    'barabbas_insurgent': {'case_export': 'act3CaseD', 'npc_id': 'barabbas_insurgent_trial', 'npc_name': 'Barabbas the Insurgent'},
    'pontius_pilate': {'case_export': 'act3CaseD', 'npc_id': 'pontius_pilate_trial', 'npc_name': 'Pontius Pilate'},
    'pilates_secretary': {'case_export': 'act3CaseD', 'npc_id': 'pilates_secretary', 'npc_name': "Pilate's Secretary"},
    'informant_bribe': {'case_export': 'act3CaseD', 'npc_id': 'informant_bribe', 'npc_name': 'Market Informant'},
    'eleazar_sadducee': {'case_export': 'act1CaseA', 'npc_id': 'eleazar', 'npc_name': 'Eleazar (Sadducee)'}, # Correct
    'simon_cyrene': {'case_export': 'act3CaseE', 'npc_id': 'simon_cyrene', 'npc_name': 'Simon of Cyrene'}, # Corrected
    ...
    'simon_leper': {'case_export': 'act2CaseD', 'npc_id': 'simon_leper', 'npc_name': 'Simon the Leper'}, # Corrected case_export
    ...
    'peter_olivet': {'case_export': 'act2CaseC', 'npc_id': 'peter_olivet', 'npc_name': 'Peter'}, # Added
    'john_olivet': {'case_export': 'act2CaseC', 'npc_id': 'john_olivet', 'npc_name': 'John'}, # Added
    'thomas_olivet': {'case_export': 'act2CaseC', 'npc_id': 'thomas_olivet', 'npc_name': 'Thomas'}, # Added
    'andrew_olivet': {'case_export': 'act2CaseC', 'npc_id': 'andrew_olivet', 'npc_name': 'Andrew'}, # Added
    'mary_bethany_anointing': {'case_export': 'act2CaseD', 'npc_id': 'mary_bethany', 'npc_name': 'Mary of Bethany'}, # Added
    'judas_bethany_objection': {'case_export': 'act2CaseD', 'npc_id': 'judas_bethany', 'npc_name': 'Judas Iscariot'}, # Added
    'simon_leper_host': {'case_export': 'act2CaseD', 'npc_id': 'simon_leper', 'npc_name': 'Simon the Leper'}, # Added
    'temple_inspection_scribe': {'case_export': 'act2CaseD', 'npc_id': 'temple_scribe_hillel', 'npc_name': 'Hillel'}, # Added
    'caiaphas_trial': {'case_export': 'act3CaseC', 'npc_id': 'caiaphas_trial', 'npc_name': 'Caiaphas'}, # Added
    'peter_denial_trial': {'case_export': 'act3CaseC', 'npc_id': 'peter_denial_trial', 'npc_name': 'Peter'}, # Added
    'false_witness': {'case_export': 'act3CaseC', 'npc_id': 'false_witness_trial', 'npc_name': 'Ananias'}, # Added
    'pontius_pilate_barabbas': {'case_export': 'act3CaseD', 'npc_id': 'pontius_pilate_trial', 'npc_name': 'Pontius Pilate'}, # Added
    'barabbas_insurgent_trial': {'case_export': 'act3CaseD', 'npc_id': 'barabbas_insurgent_trial', 'npc_name': 'Barabbas'}, # Added
    'temple_curtain': {'case_export': 'act3CaseE', 'npc_id': 'temple_priest_pashhur', 'npc_name': 'Pashhur'}, # Added
    'guard_report_crucifixion': {'case_export': 'act3CaseE', 'npc_id': 'execution_guard', 'npc_name': 'Crucifixion Guard'}, # Added
    'mary_resurrection': {'case_export': 'act4CaseA', 'npc_id': 'mary_magdalene', 'npc_name': 'Mary (Resurrection)'},
    'judas_betrayal': {'case_export': 'act3CaseA', 'npc_id': 'judas', 'npc_name': 'Judas (Betrayal)'},
    'herods_servant': {'case_export': 'act3CaseD', 'npc_id': 'herods_servant', 'npc_name': "Herod's Servant"},
    'peter_restored': {'case_export': 'act4CaseC', 'npc_id': 'peter', 'npc_name': 'Peter (Restored)'},
    'thomas_restoration': {'case_export': 'act4CaseC', 'npc_id': 'thomas', 'npc_name': 'Thomas'}, # Added
    'nathanael_disciple': {'case_export': 'act4CaseC', 'npc_id': 'nathanael', 'npc_name': 'Nathanael'}, # Added
    'peter_ascension': {'case_export': 'act4CaseD', 'npc_id': 'peter_ascension', 'npc_name': 'Peter'},
    'john_ascension': {'case_export': 'act4CaseD', 'npc_id': 'john_ascension', 'npc_name': 'John'},
    'thomas_ascension': {'case_export': 'act4CaseD', 'npc_id': 'thomas_ascension', 'npc_name': 'Thomas'},
    'angelic_messengers_ascension': {'case_export': 'act4CaseD', 'npc_id': 'angelic_messengers', 'npc_name': 'Angelic Messengers'},
}
...
def main():
    ...
    for cf_name, exports in CASE_FILES:
        full_path = Path(__file__).resolve().parent / cf_name
        case_contents[cf_name] = load_case_file(full_path)
