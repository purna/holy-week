// ============================================================
// CHARACTER: Nathanael (Disciple)
// ACT: Act IV
// CASE: Peter's Restoration
// CASE ID: peter_restoration
// SOURCE: NPC 'nathanael_disciple'
// BIBLE REFERENCE: John 21:1-14; John 1:47; John 20:11-18
// ------------------------------------------------------------
// PURPOSE: Witness to the breakfast on the shore and Peter's
// threefold reinstatement; also the collection's voice on the
// reliability of the testimony behind the whole case.
// ------------------------------------------------------------
...
//     Insight: The charcoal fire that once witnessed Peter's denial
//     (John 18:18) now witnesses his restoration.
//   - Ezekiel 34:11-16  [evidence: miraculous_catch, bread_breakfast,
//     threefold_commission — John 21:9-17]
//     Gospel: The Lord Himself promised to seek, gather, and feed
//     His scattered sheep.
//     Insight: The threefold commission — feed, tend, feed —
//     answers the threefold denial point for point.
//   - Psalm 16:10  [evidence: galilean_apparition — John 21:12]
//     Gospel: God's Holy One would not see decay.
//     Insight: Nathanael's own eyewitness recognition of the risen
//     Jesus on the shore is confirming testimony to this promise.
//   - Isaiah 53:10-11  [evidence: galilean_apparition — John 21:12]
//     Gospel: The Servant would live again after His suffering and
//     "see his offspring."
//     Insight: The disciples gathered on the beach are that
//     promised offspring, witnesses to the Servant's vindication.
// ------------------------------------------------------------
// BIBLICAL CONTEXT:
//   Summary: Nathanael was one of seven disciples who joined Peter
//   fishing on the Sea of Galilee; after a fruitless night, the
//   risen Jesus appeared on the shore, directed the miraculous
//   catch, and shared breakfast before restoring Peter.
//   Significance: As the disciple Jesus once called "in whom there
//   is no deceit" (John 1:47), Nathanael's presence underscores the
//   scene as witnessed truth, not private testimony.
// ============================================================
...
If you want to know whether any of this can be trusted — start with the fact that the first witnesses to the empty tomb were women whose word the courts would not even hear, and the men wrote it down anyway. That is not how you build a convenient lie. That is how you record what actually happened.
