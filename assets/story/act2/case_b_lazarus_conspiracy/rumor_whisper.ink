// ============================================================
// CHARACTER: The Blind Man of Bethsaida
// ACT: Act II
// CASE: The Price of Life
// CASE ID: lazarus_plot
// SOURCE: formerly rumor_whisper (orphan file) — now integrated
// BIBLE REFERENCE: John 9:1–12; John 12:9–11
// ------------------------------------------------------------
// PURPOSE: First-hand witness to a miraculous healing — connects
// the pattern of signs that led the Sanhedrin to conspire against
// both Jesus and Lazarus. The blind man's testimony is evidence
// of Jesus's authority over darkness, paralleling Lazarus's
// resurrection as evidence of authority over death.
// BIBLICAL CONTEXT:
//   Summary: Jesus healed a man born blind on the Sabbath, creating
//   a sign that forced the Pharisees to confront the question of
//   His authority. The man's simple testimony — "I was blind, but
//   now I see" — became a living refutation to those who claimed
//   He worked by darkness.
//   Significance: The healing of the blind man and the raising of
//   Lazarus form a paired testimony — one restores sight, the other
//   restores life. Both point to the same divine authority.
// ============================================================
