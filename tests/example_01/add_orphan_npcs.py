...
def main():
    ...
    for basename in orphans:
        ...
        if not info:
            continue
        key = (info["case_file"] if "case_file" in info else f"{info['act']}_case_improved.js", info["case_export"])
        # Map act letters to filenames
        act_map = {"act1": "act1_case_improved.js", "act2": "act2_case_improved.js", 
                   "act3": "act3_case_improved.js", "act4": "act4_case_improved.js",
                   "global": None}
