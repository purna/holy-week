...
export const act1CaseA = {
  ...
  npcs: [
    ...
    },
    {
      ...
      faction: "scribes",
      avatar: "👨\u200d🦰",
      profileFile: "./characters/john_apostle.json",
      color: 0x66aaff,
      pos: [10, 0, -8],
      truthfulness: 0.9,
    ...
    },
    {
      ...
      faction: "local",
      avatar: "👴",
      profileFile: "./characters/tobias_owner.json",
      color: 0x88cc88,
      pos: [-5, 0, -12],
      truthfulness: 0.95,
    ...
    },
    {
      ...
      faction: "local",
      avatar: "👩\u200d🌾",
      profileFile: "./characters/jemimah.json",
      color: 0xba93db,
      pos: [12, 0, -15],
      truthfulness: 0.8,
    ...
    },
    {
      ...
      faction: "temple",
      avatar: "🏛️",
      profileFile: "./characters/eleazar.json",
      color: 0x94a3b8,
      pos: [5, 0, -5],
      truthfulness: 0.3,
  ...
  npcs: [
    {
      ...
      faction: "temple",
      avatar: "🤑",
      profileFile: "./characters/malachi_moneychanger.json",
      color: 0xffdd66,
      pos: [-6, 0, 6],
      truthfulness: 0.5,
      bibleRef: "Mark 11:15",
