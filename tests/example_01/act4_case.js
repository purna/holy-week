  ...
  npcs: [
    {
      ...
      avatar: "👩",
      profileFile: "./characters/mary_magdalene.json",
      truthfulness: 0.98,
      bibleRef: "John 20:1–18; Mark 16:9; Luke 8:1–3",
      hasDialogue: true,
      storyFile: "./story/mary_magdalene.json",
...
export const act4CaseB = {
  ...
  npcs: [
    ...
    },
    {
      ...
      avatar: "📜",
      profileFile: "./characters/pilate_secretary.json",
      truthfulness: 0.90,
...
export const act4CaseC = {
  ...
  npcs: [
    ...
    },
    {
      ...
      faction: "local",
      avatar: "👨‍🌾",
      profileFile: "./characters/nathanael_disciple.json",
      color: 0x88cc88,
      pos: [-5, 0, 7],
      truthfulness: 0.9,
