...
For files NOT referenced in any actX_case_improved.js, the script pulls
...
CASE_FILES = [
    ...
    ("act4_case_improved.js", [
        "act4CaseA",  # resurrection / The Empty Tomb
        "act4CaseB",  # barabbas_choice / The Guard's Report
    ]),
]
