...
export const act3CaseC = {
  id: "crucifixion_site",
  title: "The Curtain and the Cross",
  subtitle: "Golgotha has fallen silent after a grueling afternoon. The sky went dark, the earth shook, and a Roman spear was drawn—yet the dynamic evidence tells a far larger story.",
  location: "upperroom",
  timeOfDay: "night",
  difficulty: 3,
  ...
  actLabel: "Act III",
  color: 0xef4444,
  quest: { name: "Crucifixion Investigation", task: "Analyze cosmic and structural signs", cur: 0, tar: 7 },
...
"torn_veil_thread+shattered_limestone": { exposed: "Fine! The earthquake rifts directly struck the Temple foundations at the exact moment the man died on Golgotha[cite: 3, 5, 7]. The great doors slammed open, the massive veil split completely in two from top to bottom[cite: 3, 5, 7], and the sanctuary is left bare[cite: 6, 7]. Our old structural monopoly over the presence of God collapsed in three seconds[cite: 3, 6, 7]." },
    ...
    },
    {
      ...
      dialogueId: "joseph_arimathea",
      role: "Secret Disciple & Council Member",
      avatar: "📜",
      truthfulness: 0.9,
      bibleRef: "Luke 23:50–53; John 19:38–42",
      background: "Joseph of Arimathea is a wealthy member of the Sanhedrin who had privately opposed the vote to condemn Jesus (Luke 23:51). He is described as 'waiting for the Kingdom of God' (Mark 15:43). After the crucifixion, he risked his reputation by going publicly to Pilate to ask for the body. He provided his own newly cut tomb in the garden. Nicodemus came with him, bringing 75 pounds of burial spices (John 19:39).",
      dialogue: {
        ...
        exposed: "And now it is gone. The linens are there. The tomb is open. I walked inside this morning. I stood where I placed Him. And I find I am no longer grieving the way I expected to. Peter examined the grave clothes first, noting the sudarium was separately rolled up. That's when I took them — I could not leave them exposed to the elements.",
      ...
      reactions: {
        ...
        burial_linen: { text: "I chose those linens myself. The finest cloth I could obtain quickly before the Sabbath began. When Peter examined them, he saw the sudarium was separately rolled up. That's when I took them all — I could not leave them exposed.", isLie: false },
      },
      contradictions: {
        "burial_linen+rolled_stone": { exposed: "You want to know what I think? I've read Psalm 16:10. 'You will not let your holy one see corruption.' I read it as poetry before. I was wrong. The linens are arranged as if a body simply passed through them. The stone is resting, not tumbled. And my testimony about the guard — no one slept through that. This tomb is empty. He said it would be. I am beginning to believe He was right." },
        "burial_linen+torn_veil_thread": { exposed: "Peter examined the grave clothes first. He saw that the face cloth was rolled up separately. I took them both — the main wrappings and the sudarium. When I unfolded the sudarium later... His image was there. Forged into the linen itself. Not painted, not pressed. I kept it secret." },
      },
    },
  ],
