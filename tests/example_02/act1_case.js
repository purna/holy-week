...
export const act1CaseA = {
  ...
  npcs: [
    ...
    },
    {
      ...
      contradictions: {
        "rope_fibers+witness_account": { exposed: "Fine. The rope wasn't hacked. And the owner Tobias practically handed it to them. But don't you see? This 'fulfillment' is a match to a tinderbox.", corrects: "neutral" }
      }
    },
    {
      id: "villager",
    ...
    },
    {
      ...
      avatar: "👨‍⚖️",
      bibleRef: "Luke 19:39–40; John 12:19",
      hasDialogue: false
    }
  ],
...
,
    ...
    },
    {
      ...
      avatar: "😤",
      profileFile: "displaced_merchant",
      truthfulness: 0.7,
    ...
    },
    {
      ...
      avatar: "🏛️",
      profileFile: "sadducee_authority",
      truthfulness: 0.4,
...
,
    ...
    },
    {
      ...
      avatar: "👳",
      bibleRef: "Matthew 21:12",
      background: "A local trader licensed directly by the Sanhedrin.",
      hasDialogue: false
    }
  ],
