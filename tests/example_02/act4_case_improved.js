...
export const act4CaseA = {
  ...
  npcs: [
    ...
    },
    {
      ...
      reactions: {
        burial_linen: { text: "I chose those linens myself. The finest cloth I could obtain quickly before the Sabbath began. When Peter examined them, he saw the sudarium was separately rolled up. That's when I took them all — I could not leave them exposed.", isLie: false, revealedClue: "burial_linen" },
